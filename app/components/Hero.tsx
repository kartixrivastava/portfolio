      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="w-full h-full rounded-xl bg-[#0a0a0a] border border-white/10 shadow-2xl flex flex-col overflow-hidden relative z-10 max-w-full">
            ...
            <div className="p-4 sm:p-6 font-mono text-xs sm:text-sm text-green-400 opacity-80 flex flex-col gap-2 overflow-hidden wrap-break-word">
              ...
              <div className="pl-4 shrink-0">
                name:{" "}
                <span className="text-yellow-300">'Kartik Srivastava'</span>,
              </div>
              <div className="pl-4 shrink-0">
                role:{" "}
              ...
              <div className="pl-4 shrink-0 whitespace-normal">
                passion:{" "}
                <span className="text-yellow-300">'Scalable web apps'</span>
              </div>
              <div>{"};"}</div>
        ...
        >
          ...
          <p className="text-lg md:text-xl text-muted max-w-xl leading-relaxed">
            Frontend developer focused on building fast, scalable, and intuitive
            web applications. Strong foundation in Data Structures &amp;
            Algorithms with hands-on experience in building production-ready
            applications using React, Next.js, and TypeScript.
          </p>

          <div className="flex flex-wrap gap-3 items-center mt-2 opacity-80">
            {["React", "Next.js", "TypeScript", "JavaScript", "Tailwind"].map(
              (tech) => (
                <span
                  key={tech}
                  className="px-3 py-1 border border-white/10 rounded-md text-sm bg-white/5"
                >
                  {tech}
                </span>
              ),
          ...
          <div className="flex flex-wrap items-center gap-4 mt-4">
            <a
              href="#projects"
              className="flex items-center gap-2 bg-accent text-[#0B0F14] px-6 py-3 rounded-lg font-semibold hover:bg-accent/90 transition-all cursor-pointer"
            >
            ...
            {theme === "dark" && (
              <a
                ...
                className="flex items-center gap-2 bg-white/5 
                        text-white border border-white/10 px-6 py-3 
                        rounded-lg font-medium hover:bg-white/10 
            ...
            {theme === "light" && (
              <a
                href="/Resume/Kartik_Resume.pdf"
                download="Kartik_Srivastava_Resume.pdf"
                className="flex items-center gap-2 bg-card text-foreground border border-border px-6 py-3 rounded-lg font-medium hover:bg-accent/10 hover:border-accent/40 transition-all cursor-pointer"
              >
                <Download className="w-4 h-4" /> Download Resume
              </a>
            )}
