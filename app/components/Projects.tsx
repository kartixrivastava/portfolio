                    ...
                    <div className="space-y-16 lg:space-y-32">
                        {projects.map((project, idx) => (
                            ...
                            >
                                ...
                                <div className="w-full lg:w-1/2 aspect-video rounded-xl bg-white/5 border border-white/10 relative overflow-hidden group-hover:border-accent/40 transition-all flex items-center justify-center p-8">
                                    ...
                                    <div className="text-center">
                                        <span className="text-accent font-mono text-sm opacity-50 block mb-2">Project Preview</span>
                                        <h3 className="text-2xl sm:text-3xl font-bold text-white/20 group-hover:text-white/40 transition-colors uppercase tracking-widest leading-tight">{project.title.split('—')[0].trim()}</h3>
                                    </div>
                                </div>
